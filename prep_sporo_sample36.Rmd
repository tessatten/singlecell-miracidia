...
```{r}
d <- "/Users/ta13/R_git/miracidia_v10_scvelo/FUGI_R_D7465036/counts_filtered/"
...
```{r, include=FALSE}
saveRDS(bc2, "/Users/ta13/R_git/miracidia_v10_scvelo/FUGI_R_D7465036/bivar_knee.rds")
```
...
```{r}
write.csv(x = seu@meta.data, file = '/Users/ta13/R_git/miracidia_v10_scvelo/FUGI_R_D7465036/seu_meta_filt_FUGI_R_D7465036.csv')
write.csv(x = t(as.matrix(seu@assays$sf@counts)), file = '/Users/ta13/R_git/miracidia_v10_scvelo/FUGI_R_D7465036/seu_spliced_raw_filt_FUGI_R_D7465036.csv')
write.csv(x = t(as.matrix(seu@assays$uf@counts)), file = '/Users/ta13/R_git/miracidia_v10_scvelo/FUGI_R_D7465036/seu_unspliced_raw_filt_FUGI_R_D7465036.csv')
```

```{r, fig.height=12, fig.width=6}
cols_use <- c("nCount_sf", "nFeature_sf", "nCount_uf", "nFeature_uf")
VlnPlot(seu, cols_use, pt.size = 0.1, ncol = 1, group.by = "orig.ident")
ggsave("/Users/ta13/R_git/miracidia_v10_scvelo/FUGI_R_D7465036/36_meta.pdf", width = 25, height = 50, units = c('cm'))
```
...
ggpairs(seu@meta.data, columns = cols_use,
        ...
        progress = FALSE)
ggsave("/Users/ta13/R_git/miracidia_v10_scvelo/FUGI_R_D7465036/36_corr.pdf", width = 25, height = 25, units = c('cm'))
...
DimPlot(seu, reduction = "tsne",
        group.by = "orig.ident", pt.size = 0.5, label = TRUE, repel = TRUE) +
  scale_color_brewer(type = "qual", palette = "Set2")
ggsave("/Users/ta13/R_git/miracidia_v10_scvelo/FUGI_R_D7465036/36_tsne.pdf", width = 15, height = 10, units = c('cm'))
...
DimPlot(seu, reduction = "umap",
        group.by = "orig.ident", pt.size = 0.5, label = TRUE, repel = TRUE) +
  scale_color_brewer(type = "qual", palette = "Set2")
ggsave("/Users/ta13/R_git/miracidia_v10_scvelo/FUGI_R_D7465036/36_umap.pdf", width = 15, height = 10, units = c('cm'))
...
ggsave("/Users/ta13/R_git/miracidia_v10_scvelo/FUGI_R_D7465036/36_umap1.pdf", width = 15, height = 10, units = c('cm'))
