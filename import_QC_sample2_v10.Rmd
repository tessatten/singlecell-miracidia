...
First I am going to look at sample 2 from MIRACIDIA run 1

```{r}
run1.v10.sample2.unsorted.filt <- readRDS(file = "/Users/ta13/R_git/filtered_v10_miracidia/")
...
Cluster 22 is probably just junk - lots of MT and HSP, etc
