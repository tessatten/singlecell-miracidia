...
miracidia_neuron <- topGO_summary_all[topGO_summary_all$Cell.type=='Neuron 1' | topGO_summary_all$Cell.type=='Neuron 2' | topGO_summary_all$Cell.type=='Neuron 3' | topGO_summary_all$Cell.type=='Neuron 5' | topGO_summary_all$Cell.type=='Neuron 6' ,]
...
```{r}
new_pal <- c("#c4b7cb")
miracidia_ciliary <- topGO_summary_all[topGO_summary_all$Cell.type=='Neuron 4' ,]
miracidia_ciliary
